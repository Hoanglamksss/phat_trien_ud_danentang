...
export default function PaymentScreen() {
  ...
  const handleCreateBooking = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Đặt xe thành công',
        'Đơn hàng của bạn đã được xác nhận! Vui lòng làm thủ tục tại quầy.',
        [

          { text: 'OK', onPress: () => router.replace('/(protected)/') } 
        ]
      );
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.detailText}>Địa chỉ: 45 Trần Phú, Nha Trang (Ví dụ)</Text>
      </View>
